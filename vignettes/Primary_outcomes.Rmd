...
text(c(-9.5,-8.5,-7.5,-6.5), pmhk.pneumonia$k+1.5, c("E", "T", "E", "T"), cex=0.75)
text(c(-9,-7),     pmhk.pneumonia$k+2, c("Dexmed.", "Placebo"), cex=0.75)
par(xpd=NA)
text(log(c(0.0005, 45)), -4, c("Favours Dexmedetomidine","Favours Placebo"), pos=c(4,2), offset=-0.5, cex=0.75)
```
